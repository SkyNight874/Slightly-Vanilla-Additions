...
public class EndFarlandsDimension extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:end_farlands")
	public static final ModDimension dimension = null;
	@ObjectHolder("slightly_vanilla_additions:end_farlands_portal")
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("end_farlands"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("slightly_vanilla_additions:end_farlands")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("slightly_vanilla_additions:end_farlands"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("slightly_vanilla_additions:end_farlands"));
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new EndFarlandsItem().setRegistryName("end_farlands"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("end_farlands_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = EndFarlandsDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("end_farlands_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "end_farlands_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = EndFarlandsDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
