...
public class MushroomLanternSmallStructure extends SlightlyVanillaAdditionsModElements.ModElement {
	public MushroomLanternSmallStructure(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 137);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 750000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("slightly_vanilla_additions", "mossy_mushroom_small"));
						if (template == null)
							return false;
