...
public class MossyMushroomSmallStructure extends SlightlyVanillaAdditionsModElements.ModElement {
	public MossyMushroomSmallStructure(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 127);
	}
