...
public class MossyMushroomBigStructure extends SlightlyVanillaAdditionsModElements.ModElement {
	public MossyMushroomBigStructure(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 128);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 550000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("slightly_vanilla_additions", "mossy_mushroom_big"));
						if (template == null)
							return false;
