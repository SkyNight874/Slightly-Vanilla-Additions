...
public class MossyBushStructure extends SlightlyVanillaAdditionsModElements.ModElement {
	public MossyBushStructure(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 129);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 700000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("slightly_vanilla_additions", "mossy_mushroom_bush"));
						if (template == null)
							return false;
