...
public class MushroomLanternMoyenStructure extends SlightlyVanillaAdditionsModElements.ModElement {
	public MushroomLanternMoyenStructure(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 138);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 800000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("slightly_vanilla_additions", "mushroom_lantern_moyen"));
						if (template == null)
							return false;
