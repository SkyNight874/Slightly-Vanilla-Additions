...
public class AlteratedFungiFeature extends RandomPatchFeature {
	public static AlteratedFungiFeature FEATURE = null;
	public static Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new AlteratedFungiFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("slightly_vanilla_additions:alterated_fungi", FEATURE,
				FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
						new SimpleBlockConfiguration(
								BlockStateProvider.simple(SlightlyVanillaAdditionsModBlocks.ALTERATED_FUNGI.get().defaultBlockState())),
						List.of(), 64));
		PLACED_FEATURE = PlacementUtils.register("slightly_vanilla_additions:alterated_fungi", CONFIGURED_FEATURE, List.of(CountPlacement.of(2),
