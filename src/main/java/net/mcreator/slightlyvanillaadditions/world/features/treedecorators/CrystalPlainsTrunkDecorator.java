...
public class CrystalPlainsTrunkDecorator extends TrunkVineDecorator {
	public static final CrystalPlainsTrunkDecorator INSTANCE = new CrystalPlainsTrunkDecorator();
	public static com.mojang.serialization.Codec<CrystalPlainsTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("crystal_plains_tree_trunk_decorator");
