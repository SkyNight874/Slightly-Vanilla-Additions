...
public class CrystalMossFeature extends RandomPatchFeature {
	public static CrystalMossFeature FEATURE = null;
	public static Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new CrystalMossFeature();
		CONFIGURED_FEATURE = FeatureUtils
				.register("slightly_vanilla_additions:crystal_moss", FEATURE,
						FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
								new SimpleBlockConfiguration(
										BlockStateProvider.simple(SlightlyVanillaAdditionsModBlocks.CRYSTAL_MOSS.get().defaultBlockState())),
								List.of(), 64));
		PLACED_FEATURE = PlacementUtils.register("slightly_vanilla_additions:crystal_moss", CONFIGURED_FEATURE, List.of(CountPlacement.of(2),
