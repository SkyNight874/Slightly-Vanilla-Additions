...
public class AlteratedForestNetherLeaveDecorator extends LeaveVineDecorator {
	public static final AlteratedForestNetherLeaveDecorator INSTANCE = new AlteratedForestNetherLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("alterated_forest_nether_tree_leave_decorator");
