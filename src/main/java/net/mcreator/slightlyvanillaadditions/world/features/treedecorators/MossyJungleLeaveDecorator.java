...
public class MossyJungleLeaveDecorator extends LeaveVineDecorator {
	public static final MossyJungleLeaveDecorator INSTANCE = new MossyJungleLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mossy_jungle_tree_leave_decorator");
