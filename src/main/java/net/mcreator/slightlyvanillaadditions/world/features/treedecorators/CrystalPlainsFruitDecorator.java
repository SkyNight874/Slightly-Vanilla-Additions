...
public class CrystalPlainsFruitDecorator extends CocoaDecorator {
	public static final CrystalPlainsFruitDecorator INSTANCE = new CrystalPlainsFruitDecorator();
	public static com.mojang.serialization.Codec<CrystalPlainsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("crystal_plains_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public CrystalPlainsFruitDecorator() {
		super(0.2f);
	}
