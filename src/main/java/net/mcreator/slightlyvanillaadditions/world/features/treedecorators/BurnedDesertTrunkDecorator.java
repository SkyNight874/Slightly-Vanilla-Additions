...
public class BurnedDesertTrunkDecorator extends TrunkVineDecorator {
	public static final BurnedDesertTrunkDecorator INSTANCE = new BurnedDesertTrunkDecorator();
	public static com.mojang.serialization.Codec<BurnedDesertTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("burned_desert_tree_trunk_decorator");
