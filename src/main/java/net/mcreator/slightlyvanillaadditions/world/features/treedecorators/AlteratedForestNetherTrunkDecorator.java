...
public class AlteratedForestNetherTrunkDecorator extends TrunkVineDecorator {
	public static final AlteratedForestNetherTrunkDecorator INSTANCE = new AlteratedForestNetherTrunkDecorator();
	public static com.mojang.serialization.Codec<AlteratedForestNetherTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("alterated_forest_nether_tree_trunk_decorator");
