...
public class PoisonSwampTrunkDecorator extends TrunkVineDecorator {
	public static final PoisonSwampTrunkDecorator INSTANCE = new PoisonSwampTrunkDecorator();
	public static com.mojang.serialization.Codec<PoisonSwampTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("poison_swamp_tree_trunk_decorator");
