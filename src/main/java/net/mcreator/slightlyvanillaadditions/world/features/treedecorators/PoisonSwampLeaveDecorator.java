...
public class PoisonSwampLeaveDecorator extends LeaveVineDecorator {
	public static final PoisonSwampLeaveDecorator INSTANCE = new PoisonSwampLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("poison_swamp_tree_leave_decorator");
