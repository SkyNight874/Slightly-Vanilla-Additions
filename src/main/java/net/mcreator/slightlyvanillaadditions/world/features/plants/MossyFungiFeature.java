...
public class MossyFungiFeature extends RandomPatchFeature {
	public static MossyFungiFeature FEATURE = null;
	public static Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new MossyFungiFeature();
		CONFIGURED_FEATURE = FeatureUtils
				.register("slightly_vanilla_additions:mossy_fungi", FEATURE,
						FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
								new SimpleBlockConfiguration(
										BlockStateProvider.simple(SlightlyVanillaAdditionsModBlocks.MOSSY_FUNGI.get().defaultBlockState())),
								List.of(), 64));
		PLACED_FEATURE = PlacementUtils.register("slightly_vanilla_additions:mossy_fungi", CONFIGURED_FEATURE, List.of(CountPlacement.of(3),
