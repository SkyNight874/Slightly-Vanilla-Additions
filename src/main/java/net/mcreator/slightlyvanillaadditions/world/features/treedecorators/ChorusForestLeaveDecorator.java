...
public class ChorusForestLeaveDecorator extends LeaveVineDecorator {
	public static final ChorusForestLeaveDecorator INSTANCE = new ChorusForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("chorus_forest_tree_leave_decorator");
