...
public class MushroomLanternMoyenFeature extends Feature<NoneFeatureConfiguration> {
	public static MushroomLanternMoyenFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new MushroomLanternMoyenFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("slightly_vanilla_additions:mushroom_lantern_moyen", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("slightly_vanilla_additions:mushroom_lantern_moyen", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public MushroomLanternMoyenFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("slightly_vanilla_additions", "mushroom_lantern_moyen"));
		if (template == null)
			return false;
