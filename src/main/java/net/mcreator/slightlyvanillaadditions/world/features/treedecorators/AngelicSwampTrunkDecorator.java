...
public class AngelicSwampTrunkDecorator extends TrunkVineDecorator {
	public static final AngelicSwampTrunkDecorator INSTANCE = new AngelicSwampTrunkDecorator();
	public static com.mojang.serialization.Codec<AngelicSwampTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("angelic_swamp_tree_trunk_decorator");
