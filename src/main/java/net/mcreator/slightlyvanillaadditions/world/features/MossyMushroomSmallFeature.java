...
public class MossyMushroomSmallFeature extends Feature<NoneFeatureConfiguration> {
	public static MossyMushroomSmallFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new MossyMushroomSmallFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("slightly_vanilla_additions:mossy_mushroom_small", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("slightly_vanilla_additions:mossy_mushroom_small", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public MossyMushroomSmallFeature() {
