...
public class BurnedDesertFruitDecorator extends CocoaDecorator {
	public static final BurnedDesertFruitDecorator INSTANCE = new BurnedDesertFruitDecorator();
	public static com.mojang.serialization.Codec<BurnedDesertFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("burned_desert_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public BurnedDesertFruitDecorator() {
		super(0.2f);
	}
