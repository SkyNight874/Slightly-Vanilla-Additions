...
public class MossyJungleFruitDecorator extends CocoaDecorator {
	public static final MossyJungleFruitDecorator INSTANCE = new MossyJungleFruitDecorator();
	public static com.mojang.serialization.Codec<MossyJungleFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mossy_jungle_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MossyJungleFruitDecorator() {
		super(0.2f);
	}
