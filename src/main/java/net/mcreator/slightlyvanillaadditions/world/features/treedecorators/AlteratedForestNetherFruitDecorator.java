...
public class AlteratedForestNetherFruitDecorator extends CocoaDecorator {
	public static final AlteratedForestNetherFruitDecorator INSTANCE = new AlteratedForestNetherFruitDecorator();
	public static com.mojang.serialization.Codec<AlteratedForestNetherFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("alterated_forest_nether_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public AlteratedForestNetherFruitDecorator() {
		super(0.2f);
	}
