...
public class CrystalPlainsLeaveDecorator extends LeaveVineDecorator {
	public static final CrystalPlainsLeaveDecorator INSTANCE = new CrystalPlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("crystal_plains_tree_leave_decorator");
