...
public class MushroomLanternBigFeature extends Feature<NoneFeatureConfiguration> {
	public static MushroomLanternBigFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new MushroomLanternBigFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("slightly_vanilla_additions:mushroom_lantern_big", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("slightly_vanilla_additions:mushroom_lantern_big", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("slightly_vanilla_additions", "mushroom_lantern_big"));
		if (template == null)
			return false;
