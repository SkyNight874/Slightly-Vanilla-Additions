...
public class AngelicSwampFruitDecorator extends CocoaDecorator {
	public static final AngelicSwampFruitDecorator INSTANCE = new AngelicSwampFruitDecorator();
	public static com.mojang.serialization.Codec<AngelicSwampFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("angelic_swamp_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public AngelicSwampFruitDecorator() {
		super(0.2f);
	}
