...
public class BurnedDesertLeaveDecorator extends LeaveVineDecorator {
	public static final BurnedDesertLeaveDecorator INSTANCE = new BurnedDesertLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("burned_desert_tree_leave_decorator");
