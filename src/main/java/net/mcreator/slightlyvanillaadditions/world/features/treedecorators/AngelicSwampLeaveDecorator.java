...
public class AngelicSwampLeaveDecorator extends LeaveVineDecorator {
	public static final AngelicSwampLeaveDecorator INSTANCE = new AngelicSwampLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("angelic_swamp_tree_leave_decorator");
