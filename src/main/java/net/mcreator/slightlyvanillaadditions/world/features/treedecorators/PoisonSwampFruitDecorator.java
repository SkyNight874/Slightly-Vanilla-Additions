...
public class PoisonSwampFruitDecorator extends CocoaDecorator {
	public static final PoisonSwampFruitDecorator INSTANCE = new PoisonSwampFruitDecorator();
	public static com.mojang.serialization.Codec<PoisonSwampFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("poison_swamp_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public PoisonSwampFruitDecorator() {
		super(0.2f);
	}
