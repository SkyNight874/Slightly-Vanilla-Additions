...
public class ChorusForestFruitDecorator extends CocoaDecorator {
	public static final ChorusForestFruitDecorator INSTANCE = new ChorusForestFruitDecorator();
	public static com.mojang.serialization.Codec<ChorusForestFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("chorus_forest_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public ChorusForestFruitDecorator() {
		super(0.2f);
	}
