...
public class CyanMossFeature extends RandomPatchFeature {
	public static CyanMossFeature FEATURE = null;
	public static Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new CyanMossFeature();
		CONFIGURED_FEATURE = FeatureUtils
				.register("slightly_vanilla_additions:cyan_moss", FEATURE,
						FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
								new SimpleBlockConfiguration(
										BlockStateProvider.simple(SlightlyVanillaAdditionsModBlocks.CYAN_MOSS.get().defaultBlockState())),
								List.of(), 64));
		PLACED_FEATURE = PlacementUtils.register("slightly_vanilla_additions:cyan_moss", CONFIGURED_FEATURE,
