...
public class OldportalFeature extends Feature<NoneFeatureConfiguration> {
	public static OldportalFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new OldportalFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("slightly_vanilla_additions:oldportal", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("slightly_vanilla_additions:oldportal", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("slightly_vanilla_additions", "oldendportalframe"));
		if (template == null)
			return false;
