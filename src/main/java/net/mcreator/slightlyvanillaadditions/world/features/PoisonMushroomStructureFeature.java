...
public class PoisonMushroomStructureFeature extends Feature<NoneFeatureConfiguration> {
	public static PoisonMushroomStructureFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new PoisonMushroomStructureFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("slightly_vanilla_additions:poison_mushroom_structure", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("slightly_vanilla_additions:poison_mushroom_structure", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public PoisonMushroomStructureFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("slightly_vanilla_additions", "poison_mushroom"));
		if (template == null)
			return false;
