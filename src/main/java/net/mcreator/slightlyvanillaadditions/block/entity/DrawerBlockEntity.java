package net.mcreator.slightlyvanillaadditions.block.entity;
...
public class DrawerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public DrawerBlockEntity(BlockPos position, BlockState state) {
		super(SlightlyVanillaAdditionsModBlockEntities.DRAWER.get(), position, state);
	}
	...
	public Component getDisplayName() {
		return new TextComponent(" Iron Drawer");
	}
