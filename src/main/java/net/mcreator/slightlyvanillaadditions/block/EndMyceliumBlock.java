...
public class EndMyceliumBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:end_mycelium")
	public static final Block block = null;
	public EndMyceliumBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 117);
	}
