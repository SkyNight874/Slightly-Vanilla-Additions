...
import net.mcreator.slightlyvanillaadditions.procedures.BlueBerriesbushnofruitQuandLaPlanteEstDetruiteParUnJoueurProcedure;
import net.mcreator.slightlyvanillaadditions.procedures.BlueBerriesbushnofruitMiseAJourDuTickProcedure;
...
public class BlueBerriesbushnofruitBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:blue_berriesbushnofruit")
	public static final Block block = null;
	public BlueBerriesbushnofruitBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 57);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("blue_berriesbushnofruit");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				BlueBerriesbushnofruitMiseAJourDuTickProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				BlueBerriesbushnofruitQuandLaPlanteEstDetruiteParUnJoueurProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
