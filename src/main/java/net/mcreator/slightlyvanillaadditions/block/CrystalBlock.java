...
public class CrystalBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:crystal")
	public static final Block block = null;
	public CrystalBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 83);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("slightly_vanilla_additions:crystal_plains")))
				biomeCriteria = true;
			if (!biomeCriteria)
				continue;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS, MaterialColor.PINK).doesNotBlockMovement().sound(SoundType.GLASS)
					.hardnessAndResistance(1f, 0.5f).lightValue(0));
