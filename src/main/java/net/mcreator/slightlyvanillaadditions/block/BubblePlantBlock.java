...
public class BubblePlantBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:bubble_plant")
	public static final Block block = null;
	public BubblePlantBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 110);
	}
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BubbleItem.block, (int) (3)));
		}
