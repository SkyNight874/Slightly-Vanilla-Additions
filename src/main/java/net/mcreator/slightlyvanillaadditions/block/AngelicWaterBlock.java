...
public class AngelicWaterBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:angelic_water")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("slightly_vanilla_additions:angelic_water_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public AngelicWaterBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 130);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes
						.builder(new ResourceLocation("slightly_vanilla_additions:blocks/angelic_water_still"),
		...
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("angelic_water");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("angelic_water_flowing");
		elements.blocks.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.WATER)) {
			...
			public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
				...
				int z = pos.getZ();
				{
					...
					AngelicWaterLorsqueLeMobjoueurEntreEnCollisionAvecLeBlocProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("angelic_water"));
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ItemGroup.MISC))
				.setRegistryName("angelic_water_bucket"));
	}
