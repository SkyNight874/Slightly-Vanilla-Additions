...
public class PolishedBluestoneWallBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:polished_bluestone_wall")
	public static final Block block = null;
	public PolishedBluestoneWallBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_bluestone_wall");
		}
