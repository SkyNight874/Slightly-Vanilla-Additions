...
public class ChorusLogBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:chorus_log")
	public static final Block block = null;
	public ChorusLogBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 32);
	}
