...
public class EndMossBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:end_moss")
	public static final Block block = null;
	public EndMossBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 118);
	}
