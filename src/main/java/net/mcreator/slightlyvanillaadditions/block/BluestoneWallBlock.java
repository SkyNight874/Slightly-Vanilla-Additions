...
public class BluestoneWallBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:bluestone_wall")
	public static final Block block = null;
	public BluestoneWallBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("bluestone_wall");
		}
