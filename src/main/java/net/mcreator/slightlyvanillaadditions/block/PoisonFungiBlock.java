...
public class PoisonFungiBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:poison_fungi")
	public static final Block block = null;
	public PoisonFungiBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 139);
	}
