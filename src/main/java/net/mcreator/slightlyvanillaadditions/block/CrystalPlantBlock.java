...
public class CrystalPlantBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:crystal_plant")
	public static final Block block = null;
	public CrystalPlantBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 115);
	}
