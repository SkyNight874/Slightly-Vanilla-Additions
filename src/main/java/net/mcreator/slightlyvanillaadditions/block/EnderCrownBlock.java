...
public class EnderCrownBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:ender_crown")
	public static final Block block = null;
	public EnderCrownBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 109);
	}
