...
public class BluestoneStairsBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:bluestone_stairs")
	public static final Block block = null;
	public BluestoneStairsBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("bluestone_stairs");
		}
