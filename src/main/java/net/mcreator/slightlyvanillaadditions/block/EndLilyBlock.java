...
public class EndLilyBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:end_lily")
	public static final Block block = null;
	public EndLilyBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 116);
	}
