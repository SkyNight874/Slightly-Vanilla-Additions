...
public class CyanMossBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:cyan_moss")
	public static final Block block = null;
	public CyanMossBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 119);
	}
