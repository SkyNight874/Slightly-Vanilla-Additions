...
public class PoisonNyliumBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:poison_nylium")
	public static final Block block = null;
	public PoisonNyliumBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 30);
	}
