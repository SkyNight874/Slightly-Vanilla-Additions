...
import net.mcreator.slightlyvanillaadditions.gui.DrawerGUIGui;
...
public class DrawerBlock extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:drawer")
	public static final Block block = null;
	@ObjectHolder("slightly_vanilla_additions:drawer")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public DrawerBlock(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 101);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("drawer"));
	}
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 10f).lightValue(0));
			setRegistryName("drawer");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent(" Iron Drawer");
					}
