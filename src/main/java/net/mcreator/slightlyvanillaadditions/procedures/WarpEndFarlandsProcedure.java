...
public class WarpEndFarlandsProcedure extends SlightlyVanillaAdditionsModElements.ModElement {
	public WarpEndFarlandsProcedure(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 88);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure WarpEndFarlands!");
			return;
		}
