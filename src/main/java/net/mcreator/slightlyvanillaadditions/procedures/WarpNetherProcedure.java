...
public class WarpNetherProcedure extends SlightlyVanillaAdditionsModElements.ModElement {
	public WarpNetherProcedure(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 86);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure WarpNether!");
			return;
		}
