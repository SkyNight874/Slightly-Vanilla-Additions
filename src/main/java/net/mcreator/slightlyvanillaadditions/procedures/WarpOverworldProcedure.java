...
public class WarpOverworldProcedure extends SlightlyVanillaAdditionsModElements.ModElement {
	public WarpOverworldProcedure(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 85);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure WarpOverworld!");
			return;
		}
