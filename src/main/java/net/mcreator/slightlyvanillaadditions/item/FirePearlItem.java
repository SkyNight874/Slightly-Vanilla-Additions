...
public class FirePearlItem extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:fire_pearl")
	public static final Item block = null;
	@ObjectHolder("slightly_vanilla_additions:entitybulletfire_pearl")
	public static final EntityType arrow = null;
	public FirePearlItem(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 79);
	}
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("An Ender Pearl"));
			list.add(new StringTextComponent("but in fire"));
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(FirePearlShootItem.block, (int) (1));
		}
