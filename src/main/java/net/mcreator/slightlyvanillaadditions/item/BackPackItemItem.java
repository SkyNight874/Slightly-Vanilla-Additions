...
import net.mcreator.slightlyvanillaadditions.gui.BackPackGui;
...
public class BackPackItemItem extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:back_pack_item")
	public static final Item block = null;
	public BackPackItemItem(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 50);
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Can contain a lot of things"));
		}
