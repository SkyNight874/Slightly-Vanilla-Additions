...
import net.mcreator.slightlyvanillaadditions.gui.CrystalClockGUIGui;
...
public class CrystalClockItem extends SlightlyVanillaAdditionsModElements.ModElement {
	@ObjectHolder("slightly_vanilla_additions:crystal_clock")
	public static final Item block = null;
	public CrystalClockItem(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 96);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof CrystalClockGUIGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Can change the time"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Crystal Clock");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CrystalClockGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
