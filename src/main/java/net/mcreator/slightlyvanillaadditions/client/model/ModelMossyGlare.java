...
public class ModelMossyGlare<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("slightly_vanilla_additions", "model_mossy_glare"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_wing = partdefinition.addOrReplaceChild("left_wing",
				CubeListBuilder.create().texOffs(0, 18).mirror().addBox(3.0F, 0.0F, 0.0F, 9.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-1.5F, 15.0F, -3.0F));
		PartDefinition right_wing = partdefinition.addOrReplaceChild("right_wing",
				CubeListBuilder.create().texOffs(0, 18).addBox(-12.0F, 0.0F, 0.0F, 9.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.5F, 15.0F, -3.0F));
		PartDefinition front_legs = partdefinition.addOrReplaceChild("front_legs",
				CubeListBuilder.create().texOffs(28, 1).addBox(0.0F, 0.0F, 0.0F, 3.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.5F, 22.0F, -2.0F));
		PartDefinition middle_legs = partdefinition.addOrReplaceChild("middle_legs",
				CubeListBuilder.create().texOffs(27, 3).addBox(-1.0F, 0.0F, 0.0F, 5.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.5F, 22.0F, 0.0F));
		PartDefinition back_legs = partdefinition.addOrReplaceChild("back_legs",
				CubeListBuilder.create().texOffs(27, 5).addBox(-1.0F, 0.0F, 0.0F, 5.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.5F, 22.0F, 2.0F));
		...
		PartDefinition torso = partdefinition.addOrReplaceChild(
				"torso", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -4.0F, -5.0F, 7.0F, 7.0F, 10.0F, new CubeDeformation(0.0F))
						.texOffs(9, 48).addBox(-5.5F, -7.0F, -6.0F, 11.0F, 11.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 19.0F, 0.0F));
		PartDefinition torso_overlay = torso.addOrReplaceChild("torso_overlay",
				CubeListBuilder.create().texOffs(10, 17).addBox(-6.5F, -13.0F, -7.0F, 13.0F, 15.0F, 14.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 5.0F, 0.0F));
		PartDefinition tail_large = torso_overlay.addOrReplaceChild("tail_large",
				CubeListBuilder.create().texOffs(0, 71).addBox(-4.5F, -3.0F, -4.0F, 9.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition tail_small = tail_large.addOrReplaceChild("tail_small",
				CubeListBuilder.create().texOffs(36, 84).addBox(-3.5F, -3.0F, -3.0F, 7.0F, 13.0F, 7.0F, new CubeDeformation(0.0F)),
