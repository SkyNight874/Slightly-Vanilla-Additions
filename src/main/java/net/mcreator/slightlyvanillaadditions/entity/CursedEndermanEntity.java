...
import net.mcreator.slightlyvanillaadditions.procedures.CursedEndermanOnEntityTickUpdateProcedure;
import net.mcreator.slightlyvanillaadditions.procedures.CursedEndermanEntityIsHurtProcedure;
...
public class CursedEndermanEntity extends Monster {
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("slightly_vanilla_additions:outer_end"));
	...
	public boolean hurt(DamageSource source, float amount) {
		CursedEndermanEntityIsHurtProcedure.execute(this.getX(), this.getY(), this.getZ(), this);
	...
	public void baseTick() {
		super.baseTick();
		CursedEndermanOnEntityTickUpdateProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}
