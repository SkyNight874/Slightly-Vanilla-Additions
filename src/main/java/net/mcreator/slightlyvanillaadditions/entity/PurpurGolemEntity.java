...
public class PurpurGolemEntity extends Monster {
	public PurpurGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SlightlyVanillaAdditionsModEntities.PURPUR_GOLEM.get(), world);
	}

	public PurpurGolemEntity(EntityType<PurpurGolemEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Blocks.PURPUR_BLOCK));
	}
