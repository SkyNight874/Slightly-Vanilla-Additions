...
import net.mcreator.slightlyvanillaadditions.procedures.MossySlimeQuandLeJoueurFaitUnClicDroitSurLentiteProcedure;
...
public class MossySlimeEntity extends SlightlyVanillaAdditionsModElements.ModElement {
	public static EntityType entity = null;
	public MossySlimeEntity(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 133);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1f)).build("mossy_slime")
						.setRegistryName("mossy_slime");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16737793, -13369345, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("mossy_slime_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.AMBIENT).add(new Biome.SpawnListEntry(entity, 3, 1, 3));
		}
	...
	public static class CustomEntity extends SlimeEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(CyanMossBlock.block, (int) (1)));
		}
		...
		public boolean processInteract(PlayerEntity sourceentity, Hand hand) {
				...
				if (sourceentity instanceof ServerPlayerEntity) {
					NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
						...
						public ITextComponent getDisplayName() {
							return new StringTextComponent("Mossy Slime");
						}
						...
						public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
							...
							return new MossySlimeGUIGui.GuiContainerMod(id, inventory, packetBuffer);
						}
					}, buf -> {
			...
			Entity entity = this;
			{
				...
				MossySlimeQuandLeJoueurFaitUnClicDroitSurLentiteProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
