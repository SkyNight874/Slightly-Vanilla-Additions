...
public class BackPackGui extends SlightlyVanillaAdditionsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public BackPackGui(SlightlyVanillaAdditionsModElements instance) {
		super(instance, 49);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("slightly_vanilla_additions:textures/back_pack.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("BackPack", 60, 7, -12829636);
		}
